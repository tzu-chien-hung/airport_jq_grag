...
function handleComplete(evt, comp) {
	...
	pop1.addEventListener("mousedown", () => {
	...
	pop2.addEventListener("mousedown", () => {
	...
	pop3.addEventListener("mousedown", () => {
	...
	pop4.addEventListener("mousedown", () => {
	...
	pop5.addEventListener("mousedown", () => {
	...
	pop6.addEventListener("mousedown", () => {
	...
	pop7.addEventListener("mousedown", () => {
	...
	closeNav.addEventListener("mousedown", () => {
